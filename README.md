...
```sh
# Linux
curl -LO https://github.com/sgreben/yeetgif/releases/download/1.9.0/gif_1.9.0_linux_x86_64.tar.gz | tar xz

# OS X
curl -LO https://github.com/sgreben/yeetgif/releases/download/1.9.0/gif_1.9.0_osx_x86_64.tar.gz | tar xz

# Windows
curl -LO https://github.com/sgreben/yeetgif/releases/download/1.9.0/gif_1.9.0_windows_x86_64.zip
unzip gif_1.9.0_windows_x86_64.zip
```
