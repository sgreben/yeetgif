...
```sh
# Linux
curl -LO https://github.com/sgreben/yeetgif/releases/download/1.9.1/gif_1.9.1_linux_x86_64.tar.gz | tar xz

# OS X
curl -LO https://github.com/sgreben/yeetgif/releases/download/1.9.1/gif_1.9.1_osx_x86_64.tar.gz | tar xz
