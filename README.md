...
```sh
# Linux
curl -LO https://github.com/sgreben/yeetgif/releases/download/1.0.10/gif_1.0.10_linux_x86_64.tar.gz | tar xz

# OS X
curl -LO https://github.com/sgreben/yeetgif/releases/download/1.0.10/gif_1.0.10_osx_x86_64.tar.gz | tar xz

# Windows
curl -LO https://github.com/sgreben/yeetgif/releases/download/1.0.10/gif_1.0.10_windows_x86_64.zip
unzip gif_1.0.10_windows_x86_64.zip
```
